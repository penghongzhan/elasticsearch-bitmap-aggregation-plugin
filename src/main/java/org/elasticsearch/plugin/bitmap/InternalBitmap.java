...
public class InternalBitmap extends InternalNumericMetricsAggregation.SingleValue implements BitmapDistinct {
    ...
    InternalBitmap(String name, RoaringBitmap sum, DocValueFormat formatter, List<PipelineAggregator> pipelineAggregators,
    ...
    @Override
    public InternalBitmap doReduce(List<InternalAggregation> aggregations, ReduceContext reduceContext) {
        ...
        return new InternalBitmap(name, sum, format, pipelineAggregators(), getMetaData());
    }
